...
from symdata.bbox import bbox_pred, clip_boxes
from symdata.generate_anchor import generate_anchors_fpn, anchors_plane
from symdata.bbox import gpu_nms_wrapper
...
class ProposalFPNOperator(mx.operator.CustomOp):
    ...
    def forward(self, is_train, req, in_data, out_data, aux):
        ...
        for s in self._feat_stride_fpn:
            ...
            proposals = self._bbox_pred(anchors, bbox_deltas, (0.1, 0.1, 0.2, 0.2))
